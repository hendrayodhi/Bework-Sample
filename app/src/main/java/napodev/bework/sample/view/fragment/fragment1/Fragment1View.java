...
public class Fragment1View extends BaseFragmentViewModel {
    @Child(R.id.tDetail)
    TextView tDetail;
    ...
    public Fragment1View(BaseFragment fragment, BaseFragmentViewImpl viewImpl, BaseFragmentWorkerImpl workerImpl, LayoutInflater inflater, ViewGroup container) {
